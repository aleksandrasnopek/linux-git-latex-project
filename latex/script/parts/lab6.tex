...
\subsection*{System Kontroli Wersji (VCS)}
...
\subsection*{Git jako fundament nowoczesnej pracy zespołowej}
...
\subsection*{Repozytorium (Repository, "repo")}
...
\subsection*{Dobra praktyka: Stwórz \texttt{.gitignore} na samym początku!}
...
\subsection*{Wysyłanie zmian na serwer: \texttt{git push}}
...
\subsection*{Pobieranie zmian z serwera: \texttt{git pull}}
...
\subsection*{Nie panikuj! Wstęp do rozwiązywania konfliktów}
...
\subsection*{Pełny cykl pracy: od zera do GitHuba}
