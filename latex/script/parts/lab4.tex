...
\subsection*{Skrypt powłoki (shell script)}
...
\subsection*{Analiza uprawnień: \texttt{-rw-r--r--}}
...
\subsection*{Uprawnienia jako system ósemkowy}
...
\subsection*{Pełna tabela systemu ósemkowego uprawnień (0--7)}
\centering
...
\subsection*{Interaktywne polecenia w \texttt{top}}
...
\subsection*{Ciekawostka: \texttt{htop}}
...
\subsection*{Polecenie \texttt{pkill}}
